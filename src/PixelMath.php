...
class PixelMath
{
    ...
    public static function getBestFit($width, $height, $originalWidth, $originalHeight)
    {
        ...
        return array('width' => $finalWidth, 'height' => $finalHeight);
    }
    /**
     * Gets the best fit for a given width / height where the provided values will be used as
     ...
     */
    public static function getPlacementCoordinates($resourceSize = array(), $size = array(), $place_constant = Imanee::IM_POS_TOP_LEFT)
    {
        $x = 0;
        $y = 0;
